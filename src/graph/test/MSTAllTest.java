...
import graph.span.MSTJiangKruskal;
...
//    @Ignore
    public void test()
    {
        ...
        MSTAll gold = new MSTJiangKruskal();

        MSTAll system = new MSTJiangKruskal();
        Graph graph;
        ...
        for (i=0; i<total; i++)
        {
            ...
            System.out.println(gold.getMinimumSpanningTrees(graph).size());
            System.out.println(gold.getMinimumSpanningTrees(graph));
